...
const CONFIG = {
    ...
    DEFAULT_FEATURE_SLUG: 'surat-pernyataan'
};
...
// =========================================
export const clearSubscriptionSession = (featureSlug: string = 'surat-pernyataan') => {
...
// =========================================
export const hasSubscriptionSession = (featureSlug: string = 'surat-pernyataan'): boolean => {
    try {
